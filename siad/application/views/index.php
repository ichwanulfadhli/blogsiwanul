...
<head>
  ...
  <title>Blog si WANUL - Log in</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo base_url('template/index2.html'); ?>"><b>Log In</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="<?php echo site_url('Login/go_login'); ?>" method="post">
...
<?php
  if(!empty($this->session->userdata('notif'))){
    if($this->session->userdata('notif') == "no_access"){
?>
...
$(function() {
    ...
    $('.login-page').ready(function() {
      Toast.fire({
        type: '<?php echo $notif['type']; ?>',
        title: '<?php echo $notif['msg']; ?>'
      })
    });
});
</script>
